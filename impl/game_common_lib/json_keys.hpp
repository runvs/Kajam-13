#ifndef JAMTEMPLATE_JSON_KEYS_HPP
#define JAMTEMPLATE_JSON_KEYS_HPP
...
constexpr auto barriers = "barriers";
constexpr auto barrierHp = "barrierHp";
constexpr auto barrierRange = "barrierRange";
